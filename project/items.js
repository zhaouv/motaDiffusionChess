var items_296f5d02_12fd_4166_a7c1_b5e830c9ee3a = 
{
	...
	"shield5": {
		...
		"itemEffect": "core.status.hero.def += 100;core.setFlag('nowShield', 'shield5');core.setFlag('shield5', 1);",
	...
	"superPotion": {
		...
		"itemEffectTip": "增加7.4倍攻防和的生命",
		"useItemEffect": "var hp = Math.round(7.4 * (core.status.hero.atk + core.status.hero.def))\ncore.status.hero.hp += hp;\ncore.insertAction([\n\t{ \"type\": \"playSound\", \"name\": \"item.mp3\" },\n\t{ \"type\": \"tip\", \"text\": \"使用圣水，增加 \" + hp + \" 生命\" },\n]);",
		"canUseItemEffect": "true",
		"text": "增加7.4倍攻防和的生命",
		"hideInToolbox": true,
		"hideInReplay": true
